...
int main()
{
    ...
    //Mat srcImg = imread("D:/project/image_segment_with_cuda/image/raw/4_614-640.jpg", 0);
    //Mat srcImg = imread("D:/project/image_segment_with_cuda/image/raw/4_1224-1280.jpg", 0);
    //Mat srcImg = imread("D:/project/image_segment_with_cuda/image/raw/4_2392-1920.jpg", 0);
    Mat srcImg = imread("D:/project/image_segment_with_cuda/image/raw/4_2392-2500.jpg", 0);
    ...
    imwrite("./image/result/4_2392-2500_cpu.jpg", otsuResultImage);
    imwrite("./image/result/4_2392-2500_opencv.jpg", dstImg1);
    imwrite("./image/result/4_2392-2500_cuda.jpg", dstImg2);
